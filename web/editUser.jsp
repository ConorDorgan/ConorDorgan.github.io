                    ...
                    <div class="row">
                        ...
                        <form action="${updateUserUrl}" method="POST">
                            ...
                            <div class="form-group row py-1 justify-content-center">
                                <label for="email" class="col-2 col-form-label text-center">Email</label> 
                                <div class="col-4">
                                    <input id="email" name="email" type="text" value="${oldUser.email}" class="form-control" required="required">
                                </div>
                            </div>
                            <div class="form-group row py-1 justify-content-center">
                                <label for="password" class="col-2 col-form-label text-center">Password</label> 
                                <div class="col-4">
                                    <input id="password" name="password" type="text" value="${oldUser.password}" class="form-control" required="required">
                                </div>
                            </div>
                            <div class="form-group row py-1 justify-content-center">
                                <label for="firstName" class="col-2 col-form-label text-center">First Name</label> 
                                <div class="col-4">
                                    <input id="firstName" name="firstName" type="text" value="${oldUser.firstName}" class="form-control" required="required">
                                </div>
                            </div>
                            <div class="form-group row py-1 justify-content-center">
                                <label for="lastName" class="col-2 col-form-label text-center">Last Name</label> 
                                <div class="col-4">
                                    <input id="lastName" size="5" name="lastName" type="text" value="${oldUser.lastName}" class="form-control" required="required">
                                </div>
                            </div>
                            <div class="form-group row py-1 justify-content-center">
                                <label class="col-2 text-center">User Type</label> 
                                <div class="col-4 ">
