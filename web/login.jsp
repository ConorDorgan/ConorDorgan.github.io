<%-- 
    Document   : login
    Created on : 22 Nov 2022, 14:27:26
    Author     : Conor Dorgan
--%>
...
<fmt:setLocale value="${loc}" />
    ...
    <title>Log in - Abstract Solutions</title>
        ...
        <div class="container py-5" style="padding-top: 20px !important;">
            <div class="row mb-4 mb-lg-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    ...
                    <h2 class="fw-bold" style="margin-bottom: 0 !important;">Welcome back</h2>
                </div>
            </div>
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body text-center d-flex flex-column align-items-center" style="padding-top: 0 !important;">
                            <div class="bs-icon-xl bs-icon-circle bs-icon-primary shadow bs-icon my-4" style="margin-top: 0 !important;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-person">
                                    <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"></path>
                                </svg></div>
                            <form action="Login" method="post">
                                <div class="mb-3"><input class="form-control" type="email" id="email" name="email" placeholder="Username" style="width: 313px;" autocomplete="off"></div>
                                <div class="mb-3"><input class="form-control" type="password" id="password" name="password" placeholder="Password" style="width: 313px;"></div>
                                <div>
                                    <input class="btn btn-primary d-block w-100" type="submit" value="Login" />
                                 </div>
                                 <div class="alert-danger text-danger">${error}</div>
                            </form>
                        </div>
                    </div>
                </div>
