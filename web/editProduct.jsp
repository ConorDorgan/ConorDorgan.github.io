...
<c:url value="login.jsp" var="login">
    ...
    <header class="bg-primary-gradient pb-4">
        <div class="container pt-4 pt-xl-5">
            <div class="row pt-5 justify-content-center mx-auto" style="padding: 0px !important;">
                <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <form action="${updateProductUrl}" method="POST" enctype="multipart/form-data">
                            <input id="id" name="id" type="hidden" value="${oldProduct.id}">
                            <div class="form-group row py-1 justify-content-center">
                                <label for="name" class="col-2 col-form-label text-center">Name</label> 
                                <div class="col-5">
                                    <input id="name" name="name" type="text" class="form-control" value ="${oldProduct.name}" required="required">
                                </div>
                            </div>
                            <div class="form-group row py-1 justify-content-center">
                                <label for="description" class="col-2 col-form-label text-center">Description</label> 
                                <div class="col-5">
                                    <input id="description" name="description" type="text" class="form-control" value="${oldProduct.description}"  required="required">
                                </div>
                            </div>
                            <div class="form-group row py-1 justify-content-center">
                                <label for="Price" class="col-2 col-form-label text-center">Price</label> 
                                <div class="col-5">
                                    <input id="price" name="price" type="text" class="form-control" value="${oldProduct.price}"required="required">
                                </div>
                            </div>
                            <div class="form-group row py-1 justify-content-center">
                                <label for="file" class="col-2 col-form-label text-center">Image</label> 
                                <div class="col-5">
                            ...
                            <div class="form-group row py-1 justify-content-center">
                             <div class="form-group row py-1 justify-content-center">
                                <label for="Category" class="col-2 col-form-label text-center">Category</label> 
                                <div class="col-5">
                                    <input id="category" name="category" type="text" class="form-control" value="${oldProduct.category}" required="required">
                                </div>
                            </div>  
