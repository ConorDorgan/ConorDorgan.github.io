                            ...
                            <div class="form-group row py-1 justify-content-center">
                                ...
                                <div class="col-5">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        ...
                                        <label for="userType_0" class="custom-control-label text-center">Administrator</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input name="userType" id="userType_1" type="radio" class="custom-control-input" value="GENUSER"> 
                                        <label for="userType_1" class="custom-control-label text-center">Customer</label>
                                    </div>
                                </div>
                            </div> 
                            <div class="form-group row py-1 justify-content-center">
