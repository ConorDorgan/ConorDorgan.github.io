<%-- 
    Document   : products
    Created on : 22 Nov 2022, 14:28:45
    Author     : Conor Dorgan
--%>
...
<fmt:setLocale value="${loc}" />
    ...
    <title>Products - Abstract Solutions</title>
    <link rel="stylesheet" href="assets/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="assets/customcss/productspage.css">
...
<c:url value="login.jsp" var="login">
   ...
   <c:param name="category" value="${element}"/>
 </c:url>
                <a href="${engURL}">
...
<c:url value="login.jsp" var="login">
    ...
    <section class="py-5" style="padding-top: 0px !important; zoom: 75% !important;">
        <div class="container py-5">
            <div class="row mb-4 mb-lg-5" style="margin: 0 !important;">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 class="fw-bold">Products</h2>
                  
                </div>
            </div>
        <c:set var = "sumfilter" value = "${sum}"/>
        <c:set var = "sumfilterall" value = "${sumall}"/>
            <div class="d-flex justify-content-center" >
                <c:url value="/filter" var="type">
                        <c:param name="locale" value="${loc}"/>
                        
                     </c:url>
                            
                <form action="${type}" class="formconor"  >
                    ...
                    <div class="forminputfilter">
                        <label class="containerfil"><c:out value="${element}"/>
                            <input type="checkbox" id="pen" name="category" value="${element}" >
                            
                            <span class="checkmarkfil"></span>
                        </label>
                    </div>
                         </c:forEach>
    ...
    <div class="child">
        ...
        <div class="card" style="box-shadow: 0px 0px 8px 0px rgba(55, 99, 244, 1)  !important;">
            <div  style="overflow: hidden;">
                <img src="data:image/jpeg;base64,${product.base64EncodedImage}" style="transform: rotate(-40deg);height:15rem !important;" alt="No Image Found In Database" >
            </div>
          
            <h3 class ="title">${product.getName()}</h3>
            <p class="price" style=" margin: 0;">€${product.getPrice()}</p>
