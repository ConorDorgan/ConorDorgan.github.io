...
<body>
    ...
    <section class="py-5" style="padding-top: 0px !important;">
        <div class="container py-5"  style="padding-top: 0px !important;">
            ...
            <div class="tainer">
        <div class="imgBx">
            <img src="assets\img\team\user-286.png" alt="No Image Available" height="440px"  >
        </div>
        <div class="details">
            <div class="content">
                <h2><c:out value="${SKUSER.firstName} ${SKUSER.lastName}"/></br>
                    <span>Email</span>
                </h2>
                <p style="margin: 5px; margin-left: 35px;">
                    ${SKUSER.email}
                </p>
                <h2><span>Account Type</span></h2>
                <p style="margin: 5px; margin-left: 35px;">
                    ${SKUSER.userType}
                </p>
                <h2>
