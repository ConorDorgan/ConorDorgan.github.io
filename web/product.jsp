<%-- 
    Document   : product
    Created on : 22 Nov 2022, 14:28:02
    Author     : Conor Dorgan
--%>
...
<fmt:setLocale value="${loc}" />
    ...
    <title>Product - Abstract Solutions</title>
...
<body>
    ...
    <section class="py-5" style="padding-top: 0px !important;">
        <div class="container py-5"  style="padding-top: 0px !important;">
            ...
            <div class="tainer">
        <div class="imgBx">
            <img src="data:image/jpeg;base64,${prod.base64EncodedImage}" alt="No Image Available" height="440px"  >
        </div>
        <div class="details">
            <div class="content">
                <h2><c:out value="${prod.getName()}" /> <br>
                ...
                <c:choose>
                    <c:when test="${not empty SKUSER}">
                    <form action="cart" style="margin-left:30px;">
                        ...
                        <c:otherwise>
                            <form action="login.jsp" style="margin-left:30px;">
                       
                        <c:set var="error" value="Please login to add to cart" scope="session" />
                        </div>  
