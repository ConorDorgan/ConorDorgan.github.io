...
<c:url value="login.jsp" var="login">
    ...
    <header class="bg-primary-gradient" style="zoom :80% !important;height: 40rem">
        <div class="container pt-4 pt-xl-5">
            <div class="row pt-5" style="padding-top: 0 !important;">
                <div class="col-md-8 col-xl-6 text-center text-md-start mx-auto">
                    <div class="text-center">
                        <%session.invalidate();%>
                        <h2 class="fw-bold text-success mb-2 align-items-center" style="font-size: 5em;margin-bottom: 0 !important; color:#3763f4 !important;" >Congratulations</h2>
                        <h2 class="fw-bold text-success mb-2" style="font-size: 1em;margin-bottom: 0 !important; color:grey !important;" >Your Order of has been successfully placed and is on its way to you </h2>
                        <img src="assets/img/confirm.gif" height="250rem">
