<%-- 
    Document   : index
    Created on : 22 Nov 2022, 14:25:00
    Author     : Conor Dorgan
--%>
...
<c:url value="login.jsp" var="login">
    ...
    <header class="bg-primary-gradient" style="zoom :80% !important; ">
        <div class="d-flex flex-column min-vh-100 justify-content-center align-items-center">
            <div class="row pt-5" style="padding-top: 0 !important; width: 100%;">
                ...
                <div class="col-12 col-lg-10 mx-auto justify-content-center align-content-center">
                    <script src="https://code.jquery.com/jquery-1.10.2.js"
	type="text/javascript"></script>
<script>
    $(document).ready(function() {
    $('#idfieldconor').keyup(function() {
        $.ajax({
            url : 'Ajax',
            data : {
                idfieldconor : $('#idfieldconor').val()
            },
  ...
  for (var i = 0; i < products.length; i++) {
    ...
    html +=  '<li><a href="/SuperSuplies/product?id='+product.id+'" style="overflow:hidden;">'+product.name+'</a></li>';
  }
...
#ajaxGetUserServletResponse li a {
  border: 1px solid #ddd;
...
#ajaxGetUserServletResponse li a:hover:not(.header) {
...
<div class="searchbar">
    ...
    <h2><fmt:message key="search"/> :</h2>  <div class="searchinput"><input type="text" id="idfieldconor" />
                </div>
    <div class="searchresults" >
                 <ul id="ajaxGetUserServletResponse">
    </div>
                 </ul>
</div>
                </div>
