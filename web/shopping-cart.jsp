<%-- 
    ...
    Created on : 22 Nov 2022, 14:30:35
    Author     : Conor Dorgan
--%>
...
<fmt:setLocale value="${loc}" />
    ...
    <title>Shopping Cart - Abstract Solutions</title>
    <!-- CSS only -->
    <!-- JavaScript Bundle with Popper -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4" crossorigin="anonymous"></script>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-rbsA2VBKQhggwzxH7pPCaAqO46MgnOM80zW1RWuH61DGLwZJEdK2Kadq2F9CUG65" crossorigin="anonymous">
    <link rel="stylesheet" href="assets/customcss/cartcss.css">
...
<c:url value="login.jsp" var="login">
    ...
    <!<!-- This is the Checkout Content -->
    
    <section class="h-100 h-customss"  >
...
box-shadow: 0px 0px 8px 0 #3763f4;" >
      ...
      <p> There are ${fn:length(cart)} items in your cart</p>
                  </div>
                  <div>
...
<c:set var="total" value="0" ></c:set>
            ...
            <c:forEach var="item" items="${cart}">
                ...
                <div class="card mb-3" style="box-shadow: 0px 0px 4px 0 #3763f4;">
                  <div class="card-body" >
                    <div class="d-flex justify-content-between">
                      <div class="d-flex flex-row align-items-center">
                        <div>
                          <img src="data:image/jpeg;base64,${item.product.base64EncodedImage}" class="img-fluid rounded-3" alt="Shopping item" style="transform: rotate(-40deg);height: 65px;">
                        </div>
                        <div class="ms-3">
                          <h5 style="font-style: italic;">${item.product.getName()}</h5>
                      ...
                      <div class="d-flex flex-row align-items-center">
                        ...
                        <div style="width: 80px;">
                          <h5 class="mb-0">€<fmt:formatNumber type = "number" maxIntegerDigits = "4" value = "${item.product.getPrice() * item.quantity}" /></h5>
                        </div>
                ...
                <div class="card bg-primary text-white rounded-3">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                      ...
                      <!<!-- CardHolder Name -->
                      <form class="mt-4" action="confirmation.jsp">
                      ...
                      <div class="form-outline form-white mb-4">
                        <input type="text" id="typeText" class="form-control form-control-lg" siez="17"
                          placeholder="1234 5678 9012 3457" minlength="19" maxlength="19" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required/>
                      ...
                      <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                          <div class="form-outline form-white">
                            <input type="password" autocomplete="false" id="typeTextii" class="form-control form-control-lg"
                    ...
                    <div class="d-flex justify-content-between">
                      ...
                      <p class="mb-2">€<fmt:formatNumber type = "number" maxIntegerDigits = "4" value = "${total}"/></p>
                    </div>
                    ...
                    <div class="d-flex justify-content-between mb-4">
                      ...
                      <p class="mb-2">€<fmt:formatNumber type = "number" maxIntegerDigits = "10" value = "${total + 20}" /></p>
                    </div>
                    
                    <input type="submit" value="Checkout"class="btn btn-info btn-block btn-lg " >
                      
                    </input>
                   <c:set var="ordertotal" value="${total}" scope="session"></c:set>
                     </form>
