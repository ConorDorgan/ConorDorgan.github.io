                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>€ ${product.price}</td>
                                    <td><img alt="img" src="data:image/jpeg;base64,${product.base64EncodedImage}" height="300" /></td>
                                    <td>${product.category}</td>
                                    <td><a href="${editProductUrl}" style="color: #3e65f6;"> Edit</a> <a href="${deleteProductUrl}" style="color: red;">Delete</a></td>
                                </tr>
                                </c:forEach>
                                <tr>
                                    <td></td>
                                    ...
                                    <td><a href="${addProductUrl}" style="color: green;"> Add </a></td>
